		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				...
				@endif
				@if (Auth::guest())
					<li><a href="{{ url('/login') }}">@lang('laraadmin.layouts.partial.notifs.login')</a></li>
					<li><a href="{{ url('/register') }}">@lang('laraadmin.layouts.partial.notifs.register')</a></li>
				@else
					<!-- User Account Menu -->
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								...
								<p>
									...
									?>
									<small>@lang('laraadmin.layouts.partial.notifs.member_since') <?php echo date("M. Y", strtotime($datec)); ?></small>
								</p>
							</li>
							<!-- Menu Body -->
							@role("SUPER_ADMIN")
							<li class="user-body">
								...
								<div class="col-xs-6 text-center mb10">
									<a href="{{ url(config('laraadmin.adminRoute') . '/la_menus') }}"><i class="fa fa-bars"></i> <span>@lang('laraadmin.layouts.partial.notifs.menus')</span></a>
								</div>
								<div class="col-xs-6 text-center mb10">
									<a href="{{ url(config('laraadmin.adminRoute') . '/la_configs') }}"><i class="fa fa-cogs"></i> <span>@lang('laraadmin.layouts.partial.notifs.configure')</span></a>
								</div>
								<div class="col-xs-6 text-center">
									<a href="{{ url(config('laraadmin.adminRoute') . '/backups') }}"><i class="fa fa-hdd-o"></i> <span>@lang('laraadmin.layouts.partial.notifs.backups')</span></a>
								</div>
							</li>
							@endrole
							<!-- Menu Footer-->
